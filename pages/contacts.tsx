          ...
          <div className={styles.contacts_info}>
            ...
            <div className={styles.wide_col}>
              ...
              <p className={styles.paragraph_small}>
                ...
                Мытищи, 4-я Парковая, строение 17 Оптово-розничная продажа мёда
                и продуктов пчеловодства.
              </p>
            </div>
            <div className={styles.wide_col}>
              <p className={styles.paragraph_light}>
                Оптовая покупка и дегустация мёда, а также оформление документов
                производится только по адресу офиса. Перед приездом свяжитесь с
                менеджером для уточнения наличия товара.
              </p>
            </div>
          </div>
        </div>
